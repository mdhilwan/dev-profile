...
export class AuthService {
  ...
  userRefSub: any;
  private recognizeUser = new BehaviorSubject<any>(null);
  ...
  recognizeUserState(): Observable<any> {
    return this.recognizeUser.asObservable();
  }
  ...
  SetUserData(user: any): void {
    ...
    this.userRefSub = userRef.valueChanges().subscribe(data => {
      if (data) {
        ...
        this.recognizeUser.next('Recognized User');
        const userData: User = {
          uid: user.uid,
          email: user.email,
        ...
        this.SignOut();
        this.recognizeUser.next('Unrecognized User');
      }
    });
  }
